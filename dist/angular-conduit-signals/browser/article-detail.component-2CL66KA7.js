...
_CommentFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CommentFormComponent, selectors: [["app-comment-form"]], inputs: { slug: "slug" }, decls: 7, vars: 2, consts: [[1, "card-comment"], [1, "card-body"], ["placeholder", "Write a comment...", "rows", "3", 1, "form-control", 3, "ngModelChange", "ngModel"], [1, "card-footer"], ["alt", "avatar", 1, "avatar", 3, "src"], [1, "btn", "bt-sm", "btn-submit", 3, "click"]], template: function CommentFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function CommentFormComponent_Template_button_click_5_listener() {
      return ctx.submit();
    });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CommentListComponent, [{
    type: Component,
    args: [{ selector: "app-comment-list", imports: [NgForOf, RouterLink, DatePipe, NgIf], changeDetection: ChangeDetectionStrategy.OnPush, template: `<div class="comment-list">\r
  <ng-container *ngFor="let comment of commentList()">\r
    <div class="card-comment">\r
      ...
      <div class="card-footer">\r
        <img alt="avatar" [src]="comment.author.image" class="avatar" />\r
        <a class="author" [routerLink]="['/@' + comment.author.username]">{{\r
          comment.author.username\r
        }}</a>\r
        <p class="date">{{ comment.createdAt | date : "MMMM d, y" }}</p>\r
        <a\r
          class="delete-btn"\r
          *ngIf="currentUser()?.username === comment.author.username"\r
          (click)="onDeleteComment(comment.id)"\r
...
function ArticleDetailComponent_ng_container_0_app_comment_form_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-comment-form", 18);
  }
  if (rf & 2) {
...
function ArticleDetailComponent_ng_container_0_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p")(1, "a", 20);
    \u0275\u0275text(2, "Sign in");
    \u0275\u0275elementEnd();
    \u0275\u0275text(3, " or ");
...
function ArticleDetailComponent_ng_container_0_ng_template_21_ng_container_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "button", 29);
    \u0275\u0275listener("click", function ArticleDetailComponent_ng_container_0_ng_template_21_ng_container_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r3);
    ...
    \u0275\u0275listener("click", function ArticleDetailComponent_ng_container_0_ng_template_21_ng_container_9_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r3);
      const article_r4 = \u0275\u0275nextContext(2).ngIf;
      const ctx_r1 = \u0275\u0275nextContext();
...
function ArticleDetailComponent_ng_container_0_ng_template_21_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ArticleDetailComponent_ng_container_0_ng_template_21_ng_template_10_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r5);
      const article_r4 = \u0275\u0275nextContext(2).ngIf;
      const ctx_r1 = \u0275\u0275nextContext();
...
function ArticleDetailComponent_ng_container_0_ng_template_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 22);
    \u0275\u0275element(1, "img", 23);
    \u0275\u0275elementStart(2, "div", 24)(3, "a", 25);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275template(9, ArticleDetailComponent_ng_container_0_ng_template_21_ng_container_9_Template, 7, 5, "ng-container", 28)(10, ArticleDetailComponent_ng_container_0_ng_template_21_ng_template_10_Template, 6, 3, "ng-template", null, 2, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_12_0;
...
function ArticleDetailComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementContainer(14, 7);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "div", 15)(16, "div", 16);
    \u0275\u0275template(17, ArticleDetailComponent_ng_container_0_app_comment_form_17_Template, 1, 1, "app-comment-form", 17)(18, ArticleDetailComponent_ng_container_0_ng_template_18_Template, 7, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275element(20, "app-comment-list", 18);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(21, ArticleDetailComponent_ng_container_0_ng_template_21_Template, 12, 13, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const article_r4 = ctx.ngIf;
    const requireLogin_r8 = \u0275\u0275reference(19);
    const articleMeta_r9 = \u0275\u0275reference(22);
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(article_r4.title);
    \u0275\u0275advance();
    \u0275\u0275property("ngTemplateOutlet", articleMeta_r9)("ngTemplateOutletContext", \u0275\u0275pureFunction0(12, _c02));
    \u0275\u0275advance(3);
    \u0275\u0275property("innerHtml", \u0275\u0275pipeBind1(9, 10, article_r4.body), \u0275\u0275sanitizeHtml);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngForOf", article_r4.tagList);
    \u0275\u0275advance(3);
    \u0275\u0275property("ngTemplateOutlet", articleMeta_r9)("ngTemplateOutletContext", \u0275\u0275pureFunction0(13, _c1));
    \u0275\u0275advance(3);
...
_ArticleDetailComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ArticleDetailComponent, selectors: [["app-article-detail"]], inputs: { slug: "slug" }, features: [\u0275\u0275ProvidersFeature([provideComponentStore(ArticleDetailStore)])], decls: 1, vars: 1, consts: [["requireLogin", ""], ["articleMeta", ""], ["editTmp", ""], [4, "ngIf"], [1, "banner"], [1, "container"], [1, "title"], [3, "ngTemplateOutlet", "ngTemplateOutletContext"], [1, "content"], [1, "article-content"], [3, "innerHtml"], [1, "tags"], [4, "ngFor", "ngForOf"], [1, "mt-5"], [1, "mt-4", "mb-5", "d-flex", "justify-content-center"], [1, "row"], [1, "col-xs-12", "col-md-8", "offset-md-2"], [3, "slug", 4, "ngIf", "ngIfElse"], [3, "slug"], [1, "tag-default"], ["routerLink", "/login", 1, "link"], ["routerLink", "/register", 1, "link"], [1, "article-meta"], ["alt", "avatar", 1, "avatar", 3, "src"], [1, "info"], [1, "author", 3, "routerLink"], [1, "date"], [1, "group-btn"], [4, "ngIf", "ngIfElse"], [1, "btn", "btn-outline-secondary", "btn-sm", 3, "click"], [1, "fa-solid", "fa-plus"], [1, "btn", "favorite-btn", "btn-sm", 3, "click", "ngClass"], [1, "fa-solid", "fa-heart"], [1, "btn", "btn-outline-secondary", "btn-sm", 3, "routerLink"], [1, "fa-solid", "fa-pen"], [1, "btn", "btn-outline-danger", "btn-sm", 3, "click"], [1, "fa-solid", "fa-trash-can"]], template: function ArticleDetailComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ArticleDetailComponent_ng_container_0_Template, 23, 14, "ng-container", 3);
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ArticleDetailComponent, [{
    ...
    args: [{ selector: "app-article-detail", imports: [
      ...
      NgClass,
      MarkdownPipe
    ], changeDetection: ChangeDetectionStrategy.OnPush, providers: [provideComponentStore(ArticleDetailStore)], template: `<ng-container *ngIf="article() as article">\r
  <div class="banner">\r
    <div class="container">\r
      <h1 class="title">{{ article.title }}</h1>\r
      <ng-container\r
        [ngTemplateOutlet]="articleMeta"\r
        [ngTemplateOutletContext]="{ type: 'header' }"\r
      ></ng-container>\r
    </div>\r
  </div>\r
  <div class="content">\r
    <div class="article-content">\r
      <div [innerHtml]="article.body | markdown"></div>\r
    </div>\r
    <div class="tags">\r
  ...
  <hr class="mt-5" />\r
  <div class="mt-4 mb-5 d-flex justify-content-center">\r
    <ng-container\r
      [ngTemplateOutlet]="articleMeta"\r
      [ngTemplateOutletContext]="{ type: 'body' }"\r
    ></ng-container>\r
  </div>\r
  <div class="row">\r
    <div class="col-xs-12 col-md-8 offset-md-2">\r
      <app-comment-form\r
        [slug]="slug"\r
        *ngIf="isAuthenticated(); else requireLogin"\r
      ></app-comment-form>\r
      <ng-template #requireLogin>\r
        <p>\r
          <a class="link" routerLink="/login">Sign in</a> or\r
          <a class="link" routerLink="/register">sign up</a> to add comments on\r
          this article.\r
        </p>\r
      </ng-template>\r
      <app-comment-list [slug]="slug"></app-comment-list>\r
    </div>\r
  </div>\r
\r
  <ng-template #articleMeta let-type="type">\r
    <div class="article-meta">\r
      <img alt="avatar" class="avatar" [src]="article.author.image" />\r
      <div class="info">\r
        <a\r
          [routerLink]="['/@' + article.author.username]"\r
          class="author"\r
          [style.color]="type === 'header' ? '#fff' : '#5CB85C'"\r
          >{{ article.author.username }}</a\r
        >\r
        <p class="date">{{ article.createdAt | date : "MMMM d, y" }}</p>\r
      </div>\r
      <div class="group-btn">\r
        <ng-container\r
          *ngIf="\r
            currentUser()?.username !== article.author.username;\r
            else editTmp\r
          "\r
        >\r
          <button\r
            class="btn btn-outline-secondary btn-sm"\r
            (click)="toggleFollowAuthor(article)"\r
          >\r
            <i class="fa-solid fa-plus"></i>\r
            {{ article.author.following ? "Unfollow" : "Follow" }}\r
            {{ article.author.username }}\r
          </button>\r
          <button\r
            class="btn favorite-btn btn-sm"\r
            [ngClass]="article.favorited ? 'unfavorite-btn' : 'favorite-btn'"\r
            (click)="toggleFavorite(article)"\r
          >\r
            <i class="fa-solid fa-heart"></i> {{ article.favorited ? 'Unfavorite Article' : 'Favorite Article'}} ({{\r
              article.favoritesCount\r
            }})\r
          </button>\r
        </ng-container>\r
        <ng-template #editTmp>\r
          <button\r
            class="btn btn-outline-secondary btn-sm"\r
            [routerLink]="['/editor', article.slug]"\r
          >\r
            <i class="fa-solid fa-pen"></i> Edit Article\r
          </button>\r
          <button\r
            class="btn btn-outline-danger btn-sm"\r
            (click)="deleteArticle(article)"\r
          >\r
            <i class="fa-solid fa-trash-can"></i> Delete Article\r
          </button>\r
        </ng-template>\r
      </div>\r
    </div>\r
...
//# sourceMappingURL=article-detail.component-2CL66KA7.js.map
