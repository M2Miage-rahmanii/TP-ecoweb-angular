...
// src/app/shared/constants/menu.ts
var NON_AUTH_MENU = [
  {
    url: "",
    title: "Home"
...
var _UserAndAuthenticationService = class _UserAndAuthenticationService {
  ...
  login(user) {
    return __privateGet(this, _httpClient).post("/users/login", {
      user
    });
  }
  register(user) {
    return __privateGet(this, _httpClient).post("/users", {
      user
    });
  }
  getCurrentUser() {
    return __privateGet(this, _httpClient).get("/user");
  }
  updateCurrentUser(user) {
    return __privateGet(this, _httpClient).put("/user", {
      user
    });
  }
};
...
var _ArticleService = class _ArticleService {
  ...
  createArticle(article) {
    return __privateGet(this, _httpClient2).post("/articles", {
      article
    });
  }
  updateArticle(slug, article) {
    return __privateGet(this, _httpClient2).put(`/articles/${slug}`, {
      article
    });
  }
  deleteArticle(slug) {
    return __privateGet(this, _httpClient2).delete(`/articles/${slug}`);
  }
  getCommentsForArticle(slug) {
    return __privateGet(this, _httpClient2).get(`/articles/${slug}/comments`);
  }
  createCommentForArticle(slug, comment) {
    return __privateGet(this, _httpClient2).post(`/articles/${slug}/comments`, {
      comment
    });
  }
  deleteCommentForArticle(slug, id) {
    return __privateGet(this, _httpClient2).delete(`/articles/${slug}/comments/${id}`);
  }
  getArticleDetail(slug) {
    return __privateGet(this, _httpClient2).get(`/articles/${slug}`);
  }
  getFeed(request) {
    return __privateGet(this, _httpClient2).get("/articles/feed", {
      params: __spreadValues({}, request)
    });
  }
  getArticleGlobal(request) {
    return __privateGet(this, _httpClient2).get("/articles", {
      params: __spreadValues({}, request)
    });
  }
  favoriteArticle(slug) {
    return __privateGet(this, _httpClient2).post(`/articles/${slug}/favorite`, {});
  }
  unfavoriteArticle(slug) {
    return __privateGet(this, _httpClient2).delete(`/articles/${slug}/favorite`);
  }
};
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-PNMNZQ7M.js.map
